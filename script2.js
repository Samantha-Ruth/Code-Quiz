...
var startQuiz = function () {
    ...
    newAnswer1El.innerHTML = "<button id='answer-one-a answer'>"
    ...
    for (var i = 0; i < listOfAnswers2.length; i++) {
        newAnswer2El.textContent = listOfAnswers2[i];
    }
    ...
    for (var i = 0; i < listOfAnswers3.length; i++) {
        newAnswer3El.textContent = listOfAnswers3[i];
    }
    ...
    for (var i = 0; i < listOfAnswers4.length; i++) {
        newAnswer4El.textContent = listOfAnswers4[i];
    }
