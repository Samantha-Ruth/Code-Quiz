...
// ** Start of quiz ** 
    // find quiz intro
    var quizQuestions = document.querySelector(".quiz-topper");
    var quizIntro = quizQuestions.querySelector(".intro")
    ...
    quizQuestions.appendChild(newQuestionEl);
    // remove old header/intro
    quizIntro.remove();

    // Target Intro paragraph and Start Button
    var startingParagraph = document.querySelector(".quiz-body");
    // remove paragraph
    startingParagraph.remove(); 
...
// Add List Element to Ordered List, with buttons inside each list element
    ...
    newAnswerEl.innerHTML = "<div id='answer-one-a answer'>1. Strings</div>"
